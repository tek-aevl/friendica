...
$a->strings['The avatar cache needs to be disabled in local.config.php to use this command.'] = 'Кэширование аватаров должно быть отключено в local.config.php для использования этой команды.';
...
$a->strings['Enter URL of an image to use as avatar (optional): '] = 'Введите URL изображения для аватара (необязательно):';
...
$a->strings['Discover'] = 'Интересное';
$a->strings['Posts from accounts that you don\'t follow, but that you might like.'] = 'Записи не из ваших подписок, которые могут понравиться. ';
...
$a->strings['Quiet sharers'] = 'Немногословные';
$a->strings['Posts from accounts that you follow but who don\'t post very often'] = 'Записи ваших друзей, которые пишут не слишком часто';
...
$a->strings['Display the community in the navigation'] = 'Показывать сообщество в главном меню';
$a->strings['If enabled, the community can be accessed via the navigation menu. Independent from this setting, the community timelines can always be accessed via the channels.'] = 'Если включено, ленты сообщества будут отображаться в главном навигационном меню. Независимо от этой настройки, ленты сообществ так же всегда доступны в меню каналов.';
...
$a->strings['Network Widgets'] = 'Виджеты лент';
$a->strings['Circles'] = 'Круги';
$a->strings['Display posts that have been created by accounts of the selected circle.'] = 'Показывать записи, созданные контактами выбранных кругов.';
$a->strings['Groups'] = 'Группы';
$a->strings['Display posts that have been distributed by the selected group.'] = 'Показывать записи из выбранных групп.';
$a->strings['Archives'] = 'Архивы';
$a->strings['Display an archive where posts can be selected by month and year.'] = 'Показывать архив записей по месяцам и годам.';
$a->strings['Protocols'] = 'Протоколы';
$a->strings['Display posts with the selected protocols.'] = 'Показывать записи по выбранным протоколам.';
$a->strings['Account Types'] = 'Тип учетной записи';
$a->strings['Display posts done by accounts with the selected account type.'] = 'Показывать записи от выбранных типов контактов.';
$a->strings['Channels'] = 'Каналы';
$a->strings['Display posts in the system channels and user defined channels.'] = 'Показывать записи из встроенных и пользовательских каналов.';
$a->strings['Saved Searches'] = 'Сохранённые поиски';
$a->strings['Display posts that contain subscribed hashtags.'] = 'Показывать записи с тегами, на которые есть подписка.';
$a->strings['Saved Folders'] = 'Сохранённые папки';
$a->strings['Display a list of folders in which posts are stored.'] = 'Показывать папки, по которым разложены записи.';
$a->strings['Own Contacts'] = 'Свои контакты';
$a->strings['Include or exclude posts from subscribed accounts. This widget is not visible on all channels.'] = 'Включить или скрыть записи от ваших контактов. Этот виджет доступен не для всех каналов.';
$a->strings['Trending Tags'] = 'Популярные тэги';
$a->strings['Display a list of the most popular tags in recent public posts.'] = 'Показывать список самых популярных тегов из недавних публичных записей.';
...
$a->strings['Search Text'] = 'Текст поиска';
...
$a->strings['Relays'] = 'Ретрансляторы';
$a->strings['All'] = 'Все';
...
$a->strings['This seems to be a relay account. They can\'t be followed by users.'] = 'Похоже, что это аккаунт релея. На такие нельзя подписаться.';
...
$a->strings['Number of items per page in stream pages (network, community, profile/contact statuses, search).'] = 'Число записей на странице (ленты, сообщества, сообщения профиля, поиск).';
$a->strings['Number of items per page in stream pages (network, community, profile/contact statuses, search) for mobile devices.'] = 'Число записей на странице (ленты, сообщества, сообщения профиля, поиск) для мобильных устройств.';
...
$a->strings['Public Group - Restricted'] = 'Публичная группа - ограниченная';
...
$a->strings['Channel Relay'] = 'Ретранслятор канала';
...
$a->strings['Nickname cannot start with a digit.'] = 'Ник не может начинаться с цифры';
$a->strings['Nickname can only contain US-ASCII characters.'] = 'Ник может содержать только латинские символы';
...
$a->strings['Contact requests have to be manually approved.'] = 'Запросы на добавление одобряются вручную.';
...
$a->strings['This page can be used to define the channels that will automatically be reshared by your account.'] = 'На этой странице можно определить каналы, которые будут автоматически публиковаться этой учётной записью.';
...
$a->strings['Minimum post size. Leave empty for no minimum size. The size is calculated without links, attached posts, mentions or hashtags.'] = 'Минимальный размер записи. Оставьте пустым для отключения. Размер считается без учёта ссылок, приложенных записей, отметок и тегов.';
$a->strings['Maximum post size. Leave empty for no maximum size. The size is calculated without links, attached posts, mentions or hashtags.'] = 'Максимальный размер записи. Оставьте пустым для отключения. Размер считается без учёта ссылок, приложенных записей, отметок и тегов.';
...
$a->strings['Default (Mastodon will display the title and a link to the post)'] = 'По-умолчанию (Mastodon будет показывать запись как заголовок и ссылку на статью)';
$a->strings['Use the summary (Mastodon and some others will treat it as content warning)'] = 'Показывать выдержку (Mastodon и некоторые другие платформы покажут это как предупреждение о контенте)';
$a->strings['Embed the title in the body'] = 'Добавлять заголовок в текст записи';
...
$a->strings['Collapse sensitive posts'] = 'Сворачивать чувствительные записи';
$a->strings['If a post is marked as "sensitive", it will be displayed in a collapsed state, if this option is enabled.'] = 'Если это включено и запись помечена как "чувствительная", она будет отображаться в свёрнутом виде.';
...
$a->strings['Color/Black'] = 'Цвет/Черная';
$a->strings['Black'] = 'Чёрная';
$a->strings['Color/White'] = 'Цвет/Светлая';
$a->strings['White'] = 'Светлая';
...
$a->strings['Hide pictures with empty alternative text'] = 'Скрывать картинки без альт-текста';
$a->strings['Don\'t display pictures that are missing the alternative text.'] = 'Не отображать картинки, у которых отсутствует альтернативный текст-описание.';
$a->strings['Hide custom emojis'] = 'Скрывать нестандартные смайлики';
$a->strings['Don\'t display custom emojis.'] = 'Не показывать нестандартные смайлики';
$a->strings['Platform icons style'] = 'Тема иконок платформ';
$a->strings['Style of the platform icons'] = 'Стиль отображения иконок платформ';
...
$a->strings['Read by: %s'] = 'Прочитано: %s';
...
$a->strings['Appearance'] = 'Внешний вид';
$a->strings['Accent color'] = 'Цвет акцентов';
