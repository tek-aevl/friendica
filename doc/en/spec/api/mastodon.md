...
- [`GET /api/v1/notifications/unread_count`](https://docs.joinmastodon.org/methods/notifications/#unread_count)
...
- [`POST /api/v1/emails/confirmations`](https://github.com/mastodon/mastodon/pull/15816)
...
- [`GET /api/v2/filters`](https://docs.joinmastodon.org/methods/filters/)
- [`POST /api/v2/filters`](https://docs.joinmastodon.org/methods/filters/)
- [`GET /api/v2/filters/:id`](https://docs.joinmastodon.org/methods/filters/)
- [`PUT /api/v2/filters/:id`](https://docs.joinmastodon.org/methods/filters/)
- [`DELETE /api/v2/filters/:id`](https://docs.joinmastodon.org/methods/filters/)
- [`GET /api/v2/filters/:filter_id/keywords`](https://docs.joinmastodon.org/methods/filters/#keywords)
- [`POST /api/v2/filters/:filter_id/keywords`](https://docs.joinmastodon.org/methods/filters/#keywords)
- [`GET /api/v2/filters/keywords/:id`](https://docs.joinmastodon.org/methods/filters/#keywords)
- [`PUT /api/v2/filters/keywords/:id`](https://docs.joinmastodon.org/methods/filters/#keywords)
- [`DELETE /api/v2/filters/keywords/:id`](https://docs.joinmastodon.org/methods/filters/#keywords)
- [`GET /api/v2/filters/:filter_id/statuses`](https://docs.joinmastodon.org/methods/filters/#statuses)
- [`POST /api/v2/filters/:filter_id/statuses`](https://docs.joinmastodon.org/methods/filters/#statuses)
- [`GET /api/v2/filters/statuses/:id`](https://docs.joinmastodon.org/methods/filters/#statuses)
- [`DELETE /api/v2/filters/statuses/:id`](https://docs.joinmastodon.org/methods/filters/#statuses)
...
- [`PATCH /api/v2/notifications/policy`](https://docs.joinmastodon.org/methods/notifications/#update-policy)
- [`GET /api/v1/notifications/requests`](https://docs.joinmastodon.org/methods/notifications/#requests)
- [`GET /api/v1/notifications/requests/:id`](https://docs.joinmastodon.org/methods/notifications/#requests)
- [`POST /api/v1/notifications/requests/:id/accept`](https://docs.joinmastodon.org/methods/notifications/#requests)
- [`POST /api/v1/notifications/requests/:id/dismiss`](https://docs.joinmastodon.org/methods/notifications/#requests)
- [`POST /api/v1/notifications/requests/accept`](https://docs.joinmastodon.org/methods/notifications/#requests)
- [`POST /api/v1/notifications/requests/dismiss`](https://docs.joinmastodon.org/methods/notifications/#requests)
- [`GET /api/v1/notifications/requests/merged`](https://docs.joinmastodon.org/methods/notifications/#requests)
...
- [`PUT /api/v1/statuses/:id/interaction_policy`](https://docs.joinmastodon.org/methods/statuses/#interaction_policy)
